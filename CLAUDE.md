...
- **Eye chart font**: Must use 'Bebas Neue' font from Google Fonts for bold, condensed aesthetic
- **Body copy font**: Must use 'Evolve Sans' font for all body text, interactive elements, and UI components
